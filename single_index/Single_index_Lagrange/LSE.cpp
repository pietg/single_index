...
List ComputeLSE(NumericMatrix X, NumericVector y, int NumStart, int m1)
{
    int             i,j,NumIt,iter,seed;
    double          *f2;
    double          sum,*alpha,*alpha_init,*alpha1,**estimate,min;
    ...
    delete[] yy, delete[] vv; delete[] alpha; delete[] alpha1; delete[] alpha_init; delete[] f;
    delete[] cumw; delete[] cs; delete[] psi; delete[] step, delete[] f2;
