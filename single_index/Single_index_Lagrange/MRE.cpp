...
List ComputeMRE(NumericMatrix X, NumericVector y, NumericVector alpha0, int m1)
{
    int             i,j,seed;
    double          sum,*alpha,*alpha_init,*alpha1;
    ...
    delete[] cumw; delete[] cs; delete[] psi; delete[] step, delete[] derivative;
